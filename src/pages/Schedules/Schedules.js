...
const BASE_URL = "https://medbook-backend-1.onrender.com/api/bookings";
      ...
      <div className="stats-section mb-4">
        ...
        <Row className="g-3">
          ...
          <Col xs={6} md={3}>
            <Card
              className={`stats-card text-center ${
                activeFilter === "pending" ? "border-warning" : ""
              }`}
          ...
          <Col xs={6} md={3}>
            <Card
              className={`stats-card text-center ${
                activeFilter === "today" ? "border-info" : ""
              }`}
          ...
          <Col xs={6} md={3}>
            <Card
              className={`stats-card text-center ${
                activeFilter === "future" ? "border-success" : ""
              }`}
